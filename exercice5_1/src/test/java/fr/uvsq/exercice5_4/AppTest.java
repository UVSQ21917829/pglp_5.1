...

{
	...
	public void testPersonnel() {
		Personnel p1 = new Personnel.Builder(0, "aa", "jj", LocalDate.parse("1997-08-01", DateTimeFormatter.ISO_DATE))
				.build();
	...
	public void testCompositePersonnel() {
		Personnel p1 = new Personnel.Builder(0, "aa", "jj", LocalDate.parse("1997-08-01", DateTimeFormatter.ISO_DATE))
				.build();
		Personnel p2 = new Personnel.Builder(5, "e", "f", LocalDate.parse("1990-09-01", DateTimeFormatter.ISO_DATE))
				.build();
		Personnel p3 = new Personnel.Builder(6, "g", "h", LocalDate.parse("1993-07-07", DateTimeFormatter.ISO_DATE))
				.build();
		...
		try (FileOutputStream fout = new FileOutputStream("compo.ser");
				ObjectOutputStream out = new ObjectOutputStream(fout);) {
	...
	public void testSerializableAffichParGroup() {
		Personnel p1 = new Personnel.Builder(1, "aa", "jj", LocalDate.parse("1997-08-01", DateTimeFormatter.ISO_DATE))
				.build();
		CompositePersonnels groupe1 = new CompositePersonnels(1);
		CompositePersonnels groupe2 = new CompositePersonnels(3);
		groupe1.addPersonnel(p1);
